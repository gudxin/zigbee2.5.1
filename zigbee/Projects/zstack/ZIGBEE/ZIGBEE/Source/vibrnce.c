...
int get_vibrance_Message()
{
  ...
  vibrance = ADC*10/33*200;
  if(vibrance >=10) vibrance = vibrance-10;
    else if(vibrance >=7) vibrance = vibrance-7;
         else if(vibrance >=5) vibrance = vibrance-5;
            else if(vibrance >=2) vibrance = vibrance-2;
